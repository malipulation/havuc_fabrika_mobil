                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        if (categoryname.isNotEmpty && outagepercent.isNotEmpty && wagecount.isNotEmpty && kilogram.isNotEmpty)  {
                          ...
                          {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Fire Miktarı Boş Girilemez!.')),
                            );
                          }
                          else if(!wagecount.isNotEmpty)
                          {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Paket Miktarı Boş Girilemez!.')),
                            );
                          }
                          else
                            {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Kilogram Boş Girilemez!.')),
                              );
                            }
